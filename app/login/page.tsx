    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 800, color: "#e8e6e1", margin: "0 0 8px", letterSpacing: "-0.5px" }}>
            IndustrialOS
          </h1>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: 10, padding: "12px 14px", color: "#e8e6e1",
            ...
            <button
              ...
              style={{
                ...
                border: "none", borderRadius: 10, color: loading ? "#7a7d8a" : "#fff",
          ...
          <div style={{ marginTop: 28, paddingTop: 24, borderTop: "1px solid #2a2d3e" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {[
                ...
                { label: "Viewer",   email: "viewer@demo.com",   pass: "viewer123",   color: "#2e7d5e" },
              ].map(d => (
                <button
                  key={d.label}
