// lib/shipping.ts
// Shared shipments store (localStorage).
// When we add the database in Phase 4, swap localStorage calls for API calls.
...
export interface Shipment {
  ...
  orderId:         string;   // links back to an order
  customer:        string;
  carrier:         Carrier;
  ...
  origin:          string;
  destination:     string;
  weight:          string;   // e.g. "12.5 kg"
  dimensions:      string;   // e.g. "40x30x20 cm"
  estimatedDate:   string;   // ISO date
  deliveredDate:   string;   // ISO date — set when delivered
...
function seedShipments(): Shipment[] {
  ...
  return [
    {
      id: "shp1", shipmentNumber: "SHP-2026-1042",
      orderId: "ORD-10234", customer: "Acme Corp",
      carrier: "FedEx", trackingNumber: "748931284756",
      status: "in_transit",
    ...
    {
      id: "shp2", shipmentNumber: "SHP-2026-0891",
      orderId: "ORD-10233", customer: "TechWave Ltd",
      carrier: "UPS", trackingNumber: "1ZRWA0680326327",
    ...
    {
      id: "shp3", shipmentNumber: "SHP-2026-0744",
      orderId: "ORD-10230", customer: "Acme Corp",
      carrier: "DHL", trackingNumber: "JDK29384756123",
      status: "delivered",
    ...
    {
      id: "shp4", shipmentNumber: "SHP-2026-1103",
      orderId: "ORD-10231", customer: "TechWave Ltd",
      carrier: "USPS", trackingNumber: "9400111899223456789",
      status: "pending",
    ...
    {
      id: "shp5", shipmentNumber: "SHP-2026-0985",
      orderId: "ORD-10229", customer: "GlobexSupply",
      carrier: "FedEx", trackingNumber: "748900129384756",
      status: "exception",
